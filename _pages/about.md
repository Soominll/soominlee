...
My primary interest lies in
  ...
  2. Integrating extensive `omics` datasets and immunological profiles to capture disease's complexity
  3. Deciphering mechanisms of `immune dynamics` and complex diseases to advance `personalized medicine` and targeted therapies.
